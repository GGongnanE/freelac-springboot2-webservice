...
import com.mickey.book.springboot.domain.posts.Posts;
import com.mickey.book.springboot.domain.posts.PostsRepository;
...
public class PostsApiControllerTest {
    ...
    public void postsModify() throws Exception {
        ...
        PostsUpdateRequestDto requestDto = PostsUpdateRequestDto.builder().title(exceptedTitle).content(exceptedContent).build();
